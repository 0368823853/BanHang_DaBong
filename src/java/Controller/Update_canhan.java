 ...
 * @author ADMIN
 */
@WebServlet(name = "Update_canhan", urlPatterns = {"/Update_canhan"})
public class Update_canhan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Update_canhan</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Update_canhan at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
