 ...
 * @author ADMIN
 */
@WebServlet(name = "Adm_khachhangServlet", urlPatterns = {"/Adm_khachhangServlet"})
public class Adm_khachhangServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Adm_khachhangServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Adm_khachhangServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    if (t != null) {
        String encodedContent = URLEncoder.encode(
                t.getTenkh() + " thanh toán với ID hoá đơn = " + t.getIdtt(),
