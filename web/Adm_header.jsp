    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="Adm_phukien.jsp" class="dropdown-item">Phụ Kiện</a>
                            <a href="Adm_giay.jsp" class="dropdown-item">Giày</a>
                        </div>
                    </div>
                    ...
                    <a href="Adm_hotro.jsp" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Hỗ trợ khách</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <a href="Adm_Dahsboard.jsp" class="sidebar-toggler flex-shrink-0">
