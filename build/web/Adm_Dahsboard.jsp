        ...
        <div class="col-sm-6 col-xl-3">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    ...
                    <h6 class="mb-0"><%= request.getAttribute("customerCount") %></h6>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xl-3">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    ...
                    <h6 class="mb-0"><%= request.getAttribute("orderCount") %></h6>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xl-3">
            <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                ...
                <div class="ms-3">
                    ...
                    <h6 class="mb-0"><%= request.getAttribute("totalProducts") %></h6>
                </div>
            </div>
        </div>
    </div>
...
<!--                    <div class="col-sm-12 col-xl-6">
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Ngày tháng hiện tại</h6>
                                <a href="">Show Lịch</a>
                            </div>
                            <div id="calender"></div>
                        </div>
