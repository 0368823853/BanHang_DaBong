<%-- 
    Document   : Adm_typography
    Created on : Oct 25, 2024, 12:54:15 AM
    Author     : ADMIN
--%>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <table border="1" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Phương thức thanh toán phổ biến nhất</td>
                                        <td>${phuongThucPhoBien}</td>
                                    </tr>
                                    <tr>
                                        <td>Lượng hàng trong kho</td>
                                        <td>${soluongsp}</td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <button><a href="BaoCaoThongKePDFServlet">Xuất PDF</a></button>
                        </div>
                    </div>
                </div>
            </div>
