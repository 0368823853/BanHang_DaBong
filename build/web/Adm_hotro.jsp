<%-- 
    Document   : Adm_table
    Created on : Oct 25, 2024, 12:52:41 AM
    Author     : ADMIN
--%>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="typography.html" class="dropdown-item">Phụ Kiện</a>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col" style="width: 100px">Mã KH</th>
                                        <th scope="col" style="width: 100px">Đánh giá</th>
